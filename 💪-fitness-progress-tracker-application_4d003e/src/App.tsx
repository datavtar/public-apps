...
const App: React.FC = () => {
  ...
  const addOrUpdateLog = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (exercise?.unit === 'reps') {
      reps = parseInt(formData.get('value') as string) || 0;
    } else {
      duration = parseInt(formData.get('value') as string) || 0;
    }
              ...
              <div className="space-y-4 mt-4">
                <div className="form-group">
                  ...
                  <select 
                    ...
                    name="exerciseId" 
                    className="input" 
                    defaultValue={editingLog?.exerciseId || ''}
                    required
                  >
                ...
                <div className="form-group">
                  ...
                  <div className="flex items-center gap-2">
                    <input 
                      ...
                      name="value" 
                      className="input" 
                      defaultValue={editingLog?.reps !== undefined ? editingLog.reps : editingLog?.duration || ''}
                      min="1" 
                      required 
                    />
                    <span className="text-gray-500 dark:text-gray-400">
                      {editingLog ? (
                        exercises.find(ex => ex.id === editingLog.exerciseId)?.unit
                      ) : (
