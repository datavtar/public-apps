            ...
            <div className="hidden md:flex items-center gap-8">
              <button 
                ...
                className={`hover:text-yellow-400 transition-colors ${
                  activeSection === 'home' ? 'text-yellow-400' : 'text-gray-300'
                }`}
              >
                Home
              </button>
              <button 
                ...
                className={`hover:text-yellow-400 transition-colors ${
                  activeSection === 'about' ? 'text-yellow-400' : 'text-gray-300'
                }`}
              >
                About
              </button>
              <button 
                ...
                className={`hover:text-yellow-400 transition-colors ${
                  activeSection === 'products' ? 'text-yellow-400' : 'text-gray-300'
                }`}
              >
                Products
              </button>
              <button 
                ...
                className={`hover:text-yellow-400 transition-colors ${
                  activeSection === 'news' ? 'text-yellow-400' : 'text-gray-300'
                }`}
              >
                News
              </button>
              <button 
                ...
                className={`hover:text-yellow-400 transition-colors ${
                  activeSection === 'contact' ? 'text-yellow-400' : 'text-gray-300'
                }`}
              >
                Contact
              </button>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-slate-700">
              <div className="flex flex-col gap-4">
                <button 
                  onClick={() => scrollToSection('home')}
                  className="text-left py-2 hover:text-yellow-400 transition-colors"
                >
                  Home
                </button>
                <button 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
                  onClick={() => scrollToSection('products')}
                  className="btn bg-yellow-500 hover:bg-yellow-600 text-slate-900 px-8 py-3 rounded-lg font-semibold transition-all hover:scale-105 flex items-center justify-center gap-2"
                >
                  Explore Products
                ...
                <button 
                  onClick={() => scrollToSection('contact')}
                  className="btn border border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-slate-900 px-8 py-3 rounded-lg font-semibold transition-all"
                >
                  Contact Us
                </button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8">
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-yellow-400">99.7%</div>
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 rounded-full flex items-center justify-center">
                <div className="aspect-square w-3/4 bg-gradient-to-br from-yellow-500/30 to-yellow-600/30 rounded-full flex items-center justify-center">
                  <Shield className="h-24 w-24 sm:h-32 sm:w-32 text-yellow-400" />
                </div>
              </div>
              <div className="absolute -top-4 -right-4 w-8 h-8 bg-yellow-400 rounded-full animate-pulse"></div>
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-yellow-500 rounded-full animate-pulse delay-300"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-wide">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              ...
              <span className="block text-yellow-400">Autonomous Defense</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="card bg-slate-700 border border-slate-600 hover:border-yellow-400 transition-colors">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="stat-card bg-slate-700 border border-slate-600">
                ...
                <div className="stat-value text-yellow-400">15+</div>
              </div>
              <div className="stat-card bg-slate-700 border border-slate-600">
                <div className="stat-title text-gray-400">R&D Investment</div>
                <div className="stat-value text-yellow-400">$2.5B</div>
              </div>
              <div className="stat-card bg-slate-700 border border-slate-600">
                <div className="stat-title text-gray-400">Patents Held</div>
                <div className="stat-value text-yellow-400">200+</div>
              </div>
              <div className="stat-card bg-slate-700 border border-slate-600">
                <div className="stat-title text-gray-400">Global Partners</div>
                <div className="stat-value text-yellow-400">75+</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="products" className="py-20 bg-slate-900">
        <div className="container-wide">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              Advanced Defense
              <span className="block text-yellow-400">Product Portfolio</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {products.map((product) => (
              <div key={product.id} className="card bg-slate-800 border border-slate-700 hover:border-yellow-400 transition-all hover:scale-105 group">
                <div className="aspect-video bg-slate-700 rounded-lg mb-4 flex items-center justify-center">
                  <Shield className="h-16 w-16 text-yellow-400 group-hover:scale-110 transition-transform" />
                </div>
                
                <div className="space-y-4">
                  <div>
                    <div className="badge bg-yellow-500/20 text-yellow-400 text-xs mb-2">
                      {product.category}
                    </div>
                  ...
                  <button 
                    onClick={() => scrollToSection('contact')}
                    className="btn w-full bg-slate-700 hover:bg-yellow-500 hover:text-slate-900 border border-slate-600 hover:border-yellow-400 text-white transition-all"
                  >
                    Request Information
                  </button>
                </div>
      ...
      <section id="news" className="py-20 bg-slate-800">
        <div className="container-wide">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {newsItems.map((item) => (
              <div key={item.id} className="card bg-slate-700 border border-slate-600 hover:border-yellow-400 transition-colors group">
                <div className="space-y-4">
                  <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">Herengracht 449a, 1017 BR Amsterdam, Netherlands</p>
                    </div>
                  </div>
              ...
              <div className="card bg-slate-800 border border-slate-700">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-yellow-400">Emergency Only</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleContactSubmit} className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="form-group">
                  ...
                  <input
                    ...
                    className="input bg-slate-800 border-slate-600 text-white focus:border-yellow-400"
                    required
                  />
                </div>
                <div className="form-group">
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  rows={5}
                  className="input bg-slate-800 border-slate-600 text-white focus:border-yellow-400 resize-none"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="btn w-full bg-yellow-500 hover:bg-yellow-600 text-slate-900 py-3 font-semibold transition-all hover:scale-105"
              >
                Send Message
              </button>
            </form>
