...
const App: React.FC = () => {
  ...
  // New section: Mission statement with two paragraphs
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-300">
            <p className="text-lg leading-relaxed">
              Welcome to ABC Talkies, an OTT platform a new age digital cinema to watch all trending movies, Old movies, new movies, biographies, TV shows online on any device. Films in every language are available for streaming. Additionally, we introduced a cinema marketplace to help filmmakers globally by upload their short films or untold stories to amuse audiences worldwide by showcasing their skills and inventiveness. Our platform is where creativity thrives and stories are shared, regardless of whether you are an undiscovered filmmaker or work in any other field but have a passion for making movies as a part of your hobby. You can explore, upload, and compete here.
            </p>
            <p className="text-lg leading-relaxed">
              Our OTT platform is made to highlight the finest in independent filmmaking by providing a platform for aspiring and seasoned filmmakers to stream, market, and make money from their work. We offer viewers a wide variety of new content that isn't available on popular platforms, ranging from compelling short films to indie original features. By putting viewers and producers in direct contact, our digital cinema marketplace helps outstanding films receive the recognition they merit. Our OTT space offers quality and creativity on demand, whether you're looking to watch independent films, find up-and-coming talent, or enjoy storytelling without filters.
            </p>
          </div>
        </div>
      </div>
  ...
  // New Big Shot Challenge registration section
