...
import {
  LayoutDashboard, Truck, User as UserIcon, Route as RouteIcon, CalendarDays, Settings, BrainCircuit, Sun, Moon, LogOut,
  PlusCircle, Edit3, Trash2, Search as SearchIcon, ArrowUpDown, Eye, X, Save, UploadCloud, DownloadCloud, FileText,
  Package, ChevronDown, ChevronUp, AlertTriangle, CheckCircle2, Info, Users, MapPin, Navigation, Fuel, Gauge, UserCircle, Sparkles, MessageSquare, Send, Image as ImageIcon, Palette, Menu
} from 'lucide-react';
