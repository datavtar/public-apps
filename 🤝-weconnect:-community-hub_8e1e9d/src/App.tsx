  ...
  const initializeData = () => {
    ...
    if (savedRooms) {
      ...
      const defaultRooms: ChatRoom[] = [
        ...
        {
          id: '2',
          name: 'Mumbai BKC Tech Entrepreneurs Community Hub',
          description: 'WeWork Bandra Kurla Complex community for technology entrepreneurs and startup founders',
          category: 'location',
          location: 'Mumbai BKC',
          memberCount: 89,
          isPrivate: false,
        ...
        {
          id: '5',
          name: 'Digital Marketing Professionals Network',
          description: 'A community for digital marketing professionals to share insights and collaborate',
          category: 'business',
          memberCount: 234,
          isPrivate: false,
          unreadCount: 15
    ...
    if (savedNotifications) {
      ...
      const defaultNotifications: Notification[] = [
        ...
        },
        {
          ...
          type: 'message',
          title: 'New Message',
          content: 'You have a new message in Tech Entrepreneurs room',
          timestamp: new Date(2025, 5, 13, 12, 15),
          read: true
        },
        {
          id: '4',
          type: 'like',
          title: 'Post Liked',
          content: 'Your post about remote work received 5 new likes',
          timestamp: new Date(2025, 5, 12, 18, 45),
          read: true
        }
      ];
...
Context: You are an AI assistant for WeConnect, a community platform for WeWork customers in India. Help users with networking, event planning, professional advice, and community engagement. Be friendly, professional, and culturally aware of the Indian business environment.`;
  ...
  // Clear all data with confirmation modal instead of window.confirm
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  <div className={`p-1 rounded-full ${
                                    ...
                                    notification.type === 'connection' ? 'bg-blue-100 dark:bg-blue-900' :
                                    notification.type === 'message' ? 'bg-purple-100 dark:bg-purple-900' :
                                    notification.type === 'like' ? 'bg-red-100 dark:bg-red-900' :
                                    'bg-gray-100 dark:bg-gray-700'
                                  }`}>
                                    {notification.type === 'event' && <Calendar className="w-3 h-3 text-green-600 dark:text-green-400" />}
                                    {notification.type === 'connection' && <UserPlus className="w-3 h-3 text-blue-600 dark:text-blue-400" />}
                                    {notification.type === 'message' && <MessageSquare className="w-3 h-3 text-purple-600 dark:text-purple-400" />}
                                    {notification.type === 'like' && <Heart className="w-3 h-3 text-red-600 dark:text-red-400" />}
                                    {notification.type === 'mention' && <AlertCircle className="w-3 h-3 text-yellow-600 dark:text-yellow-400" />}
                                  </div>
                      ...
                      <div className="overflow-x-auto scrollbar-hide">
                        <div className="flex gap-2 pb-2" style={{ minWidth: 'max-content' }}>
                          {['all', 'general', 'location', 'business', 'interest'].map(filter => (
                            <button
                              key={filter}
                              className="flex-shrink-0 px-3 py-1 text-xs rounded-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors capitalize whitespace-nowrap"
                            >
                              {filter}
                            </button>
                          ))}
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              {room.isPrivate && <Shield className="w-3 h-3 text-gray-400 flex-shrink-0" />}
                            </div>
        ...
        <div className="modal-backdrop" onClick={() => setShowConfirmClear(false)}>
          <div className="modal-content max-w-md" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Confirm Data Deletion</h3>
              <button onClick={() => setShowConfirmClear(false)} className="btn-ghost p-2">
                <X className="w-5 h-5" />
              </button>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    This action cannot be undone. All your chat history, connections, events, and settings will be permanently deleted.
                  </p>
                </div>
              </div>
            </div>
            <div className="modal-footer">
              ...
              <button onClick={confirmClearAllData} className="btn btn-error">
                Yes, Clear All Data
              </button>
            </div>
          </div>
