...
Please return a JSON object with these exact fields:
{
  ...
  }, [showPasswordModal, showTicketModal, showConfirmDialog, showNotifications]);
              ...
              {viewMode === 'customer' && (
                <div className="relative">
                  <button
                    ...
                    className="p-2 rounded-xl bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-600 transition-all relative"
                  ...
                  {showNotifications && (
                    <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 z-50 max-h-96 overflow-hidden">
                      ...
                      <div className="max-h-64 overflow-y-auto">
                        {getUserNotifications().length === 0 ? (
                          ...
                          getUserNotifications().map((notification) => (
                            <div
                              key={notification.id}
                              className={`p-4 border-b border-slate-100 dark:border-slate-700 last:border-b-0 hover:bg-slate-50 dark:hover:bg-slate-700 cursor-pointer transition-all ${
                      ...
                      >
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <div className="flex items-center gap-1">
                            <div className={`w-2 h-2 rounded-full ${getPriorityCircleColor(ticket.priority)}`}></div>
                    ...
                    >
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                          ...
                          <div className="flex items-center gap-1">
                            <div className={`w-3 h-3 rounded-full ${getPriorityCircleColor(ticket.priority)}`}></div>
                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${getPriorityColor(ticket.priority)}`}>
                              {ticket.priority}
                            </span>
                          </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full px-4 py-3 pl-8 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#548b99]"
                        >
                          <option value="low">Low</option>
                          <option value="medium">Medium</option>
                          <option value="high">High</option>
                        ...
                        <div className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-3 h-3 rounded-full ${getPriorityCircleColor(newTicket.priority)}`}></div>
                      </div>
                    </div>
                  </div>
                    ...
                    {selectedFiles.length > 0 && (
                      <div className="mt-3 space-y-2">
                        ...
                        {selectedFiles.map((file, index) => (
                          <div key={index} className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-700 p-2 rounded-lg">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <div className="flex items-center gap-1">
                        <div className={`w-3 h-3 rounded-full ${getPriorityCircleColor(selectedTicket.priority)}`}></div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <select
                              ...
                              className="w-full px-3 py-2 pl-8 bg-white dark:bg-slate-600 border border-slate-200 dark:border-slate-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#548b99]"
                            >
                              <option value="low">Low</option>
                              <option value="medium">Medium</option>
                              <option value="high">High</option>
                            ...
                            <div className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-3 h-3 rounded-full ${getPriorityCircleColor(selectedTicket.priority)}`}></div>
                          </div>
                        </div>
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 btn bg-green-600 text-white hover:bg-green-700 rounded-xl"
                >
                  Confirm
                </button>
                <button
