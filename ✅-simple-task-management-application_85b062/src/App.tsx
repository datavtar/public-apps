...
import { Plus, Trash2, Edit, Check, X, Search, ArrowUp, ArrowDown, Filter, ListTodo, Moon, Sun, ArrowDownUp } from 'lucide-react'; // Added ArrowDownUp here
      ...
      <main className="flex-grow container-narrow py-6 md:py-8">
        ...
        <div className="card card-responsive mb-6 md:mb-8 p-4 bg-gray-50 dark:bg-slate-800 theme-transition-bg">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            {/* Sort */}
            <div className="form-group reset-spacing">
              <label htmlFor="sort" className="form-label flex items-center gap-1 text-xs mb-1"><ArrowDownUp size={14}/> Sort</label> {/* Error was here */} 
              <select
                id="sort"
                value={sort}
