      ...
      <nav className="bg-white dark:bg-slate-800 shadow-sm sticky top-16 z-[var(--z-sticky)]">
        <div className="container-fluid">
          <div className="flex border-b dark:border-slate-700">
            <button 
              className={`py-4 px-6 font-medium flex items-center gap-2 ${activeTab === 'map' ? 'text-primary-600 border-b-2 border-primary-600' : 'text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-300'}`}
            ...
            <button 
              className={`py-4 px-6 font-medium flex items-center gap-2 ${activeTab === 'list' ? 'text-primary-600 border-b-2 border-primary-600' : 'text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-300'}`}
            ...
            <button 
              className={`py-4 px-6 font-medium flex items-center gap-2 ${activeTab === 'analytics' ? 'text-primary-600 border-b-2 border-primary-600' : 'text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-300'}`}
      ...
      <main className="container-fluid py-6">
        ...
        <div className="mb-6 flex flex-col sm:flex-row gap-4 items-stretch sm:items-center justify-between">
          ...
          <div className="flex gap-3">
            <button 
              className="btn bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-600 flex-center gap-2" 
              onClick={() => {
                ...
                <div className="p-0">
                  <ul className="divide-y divide-gray-200 dark:divide-slate-700 overflow-auto" style={{ maxHeight: 'calc(100vh - 280px)' }}>
                    {filteredShipments.slice(0, 10).map((shipment) => (
                      <li key={shipment.id} className="p-4 hover:bg-gray-50 dark:hover:bg-slate-700 cursor-pointer" onClick={() => handleMapClick(shipment)}>
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <div className="flex items-center mt-1">
                              <span className={`flex items-center px-2 py-0.5 rounded text-xs ${STATUS_COLORS[shipment.status]} bg-opacity-10 text-${STATUS_COLORS[shipment.status].split('-')[1]}-800 dark:text-${STATUS_COLORS[shipment.status].split('-')[1]}-200`}>
        ...
        <div className="modal-backdrop" onClick={closeAllModals}>
          ...
          >
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    className="btn bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-600 flex-center"
            ...
            <div className="modal-footer">
              <button 
                className="btn bg-gray-50 text-gray-700 hover:bg-gray-100 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600"
