...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (savedProducts) {
      ...
      // If no saved products, use initial dummy data
      setProducts(INITIAL_DUMMY_DATA);
      // Save dummy data to localStorage for future sessions
      localStorage.setItem('fruitVendorProducts', JSON.stringify(INITIAL_DUMMY_DATA));
    }
