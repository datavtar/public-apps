...
const App: React.FC = () => {
  ...
  const getPriorityColor = (priority: ParcelPriority): string => {
    ...
    const colors = {
      ...
      critical: `bg-gradient-to-r ${criticalPrioritySettings.color} text-white shadow-md`
    };
  ...
  return (
    <div id="welcome_fallback" className={`min-h-screen transition-all duration-300 ${
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 rounded-lg text-sm ${
                            isHighContrast 
                              ...
                              : 'border border-gray-300 dark:bg-slate-700 dark:border-slate-600 dark:text-white'
                          }`}
                        />
                      </div>
      ...
      {/* Tab Navigation */}
      <div className="container-wide py-4">
        <div className={`flex gap-2 p-2 rounded-2xl shadow-lg ${
          isHighContrast 
            ? 'bg-white border-2 border-black' 
            : 'bg-gradient-to-r from-white to-purple-50 dark:bg-slate-800'
        }`}>
          <button
            id="tracking-tab"
            onClick={() => setActiveTab('tracking')}
            className={`flex items-center gap-3 px-6 py-3 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 ${
              activeTab === 'tracking'
                ? (isHighContrast 
                ...
                : (isHighContrast 
                    ? 'text-black hover:bg-gray-200' 
                    : 'text-purple-600 hover:bg-purple-100 dark:text-slate-300 dark:hover:bg-slate-700')
            }`}
          >
      ...
      {activeTab === 'tracking' ? (
        ...
        <div className="container-wide py-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            {[
              { title: 'Total Parcels', value: stats.total, color: 'from-purple-400 to-pink-500', icon: Package, trend: '+12%' },
              { title: 'Delivered', value: stats.delivered, color: 'from-green-400 to-teal-500', icon: CheckCircle, trend: '+8%' },
              { title: 'Avg Delivery Time', value: `${stats.avgDeliveryTime.toFixed(1)} days`, color: 'from-blue-400 to-indigo-500', icon: Clock, trend: '-2%' },
              { title: 'Delayed', value: stats.delayed, color: 'from-red-400 to-pink-500', icon: AlertTriangle, trend: '-15%' }
            ].map((stat, index) => {
              const IconComponent = stat.icon;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className={`p-8 rounded-2xl shadow-xl transition-all duration-300 ${
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className={`p-3 rounded-xl ${
                  isHighContrast ? 'bg-gray-200' : 'bg-gradient-to-r from-purple-500 to-pink-500'
                }`}>
            ...
            <div className={`p-8 rounded-2xl shadow-xl transition-all duration-300 ${
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className={`p-3 rounded-xl ${
                  isHighContrast ? 'bg-gray-200' : 'bg-gradient-to-r from-red-500 to-orange-500'
                }`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className={`p-8 rounded-2xl shadow-xl transition-all duration-300 ${
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className={`p-3 rounded-xl ${
                  isHighContrast ? 'bg-gray-200' : 'bg-gradient-to-r from-blue-500 to-teal-500'
                }`}>
            ...
            <div className={`p-8 rounded-2xl shadow-xl transition-all duration-300 ${
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className={`p-3 rounded-xl ${
                  isHighContrast ? 'bg-gray-200' : 'bg-gradient-to-r from-green-500 to-blue-500'
                }`}>
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={dashboardData.serviceTypeData}>
                    ...
                    />
                    <Bar dataKey="parcels" fill="#3B82F6" radius={[4, 4, 0, 0]} name="Total Parcels" />
          ...
          <div className={`p-8 rounded-2xl shadow-xl transition-all duration-300 ${
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className={`p-3 rounded-xl ${
                isHighContrast ? 'bg-gray-200' : 'bg-gradient-to-r from-orange-500 to-red-500'
              }`}>
                ...
                <div key={index} className={`p-6 rounded-xl transition-all duration-300 hover:scale-105 ${
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold">{service.parcels}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className={`text-sm ${
                        isHighContrast ? 'text-gray-700' : 'text-gray-600 dark:text-slate-300'
                      }`}>Delivered:</span>
                      <span className="font-bold text-green-600">{service.delivered}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className={`text-sm ${
                        isHighContrast ? 'text-gray-700' : 'text-gray-600 dark:text-slate-300'
                      }`}>Success Rate:</span>
                      <span className={`font-bold ${service.deliveryRate >= 80 ? 'text-green-600' : service.deliveryRate >= 60 ? 'text-yellow-600' : 'text-red-600'}`}>
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <span className={`inline-flex items-center px-6 py-3 rounded-2xl text-sm font-bold ${getPriorityColor(parcel.priority)}`}>
              {getPriorityLabel(parcel.priority)} PRIORITY
            </span>
