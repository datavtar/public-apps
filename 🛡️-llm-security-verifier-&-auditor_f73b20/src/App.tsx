      ...
      <main className="container-fluid py-6">
        ...
        {activeTab === 'dashboard' && (
          <div id="generation_issue_fallback" className="space-y-6">
            ...
            {/* Key Metrics */}
            <div id="dashboard-metrics" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Recent Activity */}
            <div id="recent-activity" className="card">
        ...
        {activeTab === 'models' && (
          <div className="space-y-6">
            ...
            {/* Search and Filter */}
            <div id="models-search" className="flex gap-4">
            ...
            {/* Models Grid */}
            <div id="models-grid" className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        {activeTab === 'testing' && (
          <div className="space-y-6">
            ...
            {/* Filters */}
            <div id="testing-filters" className="flex gap-4">
              <div className="flex-1">
                <input
                  type="text"
            ...
            <div id="test-execution-panel" className="card">
            ...
            {/* Test Cases Table */}
            <div id="test-cases-table" className="card">
        ...
        {activeTab === 'vulnerabilities' && (
          <div className="space-y-6">
            ...
            <div id="vulnerability-overview" className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="stat-card">
            ...
            {/* Reports List */}
            <div id="vulnerability-reports" className="space-y-4">
        ...
        {activeTab === 'reports' && (
          <div className="space-y-6">
            ...
            {/* Report Metrics */}
            <div id="compliance-metrics" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="stat-card">
            ...
            {/* Detailed Reports */}
            <div id="executive-summary" className="card">
        ...
        {activeTab === 'settings' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* General Settings */}
              <div id="general-settings" className="card">
              ...
              {/* Data Management */}
              <div id="data-management" className="card">
